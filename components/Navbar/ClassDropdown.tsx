...
export default function ClassDropdown() {
  return (
    <>
      <Menu as="div" className="hidden text-left lg:inline-block">
        ...
        >
          <Menu.Item>
            {({ active }) => (
              <>
                <div className="flex flex-row outline-none focus:outline-none text-lg ml-6 items-baseline justify-evenly pb-8 pt-4">
                  <div className="flex flex-col py-2 outline-none focus:outline-none pt-4">
                  ...
                  <Disclosure>
                    <div className="py-2 outline-none focus:outline-none">
                      ...
                      <section className="flex flex-col pl-6 text-lg text-blue-500">
                        ...
                        <Link href="SAT-Writing-and-Grammar">
                          SAT Writing &amp; Grammar
                        </Link>
