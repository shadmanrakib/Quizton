        ...
        <main className="px-4 md:px-8">
            <div className="flex flex-col md:flex-row gap-2 items-center py-8">
                <div className="flex flex-1 flex-col">
                  <div className="font-bold text-5xl pb-8">Need to practice for your exams?</div>
                  <div className="text-2xl pb-8">Use <span className="text-brand-1 font-bold">Quizton's vast library</span> of quizzes and questions for free today.</div>
                  <Link href="/auth/signup" >
                    <button className="px-3 py-3 mt-2 w-36 rounded-lg bg-brand-1 text-xl text-white">Get Started</button>
                  </Link>
                </div>
